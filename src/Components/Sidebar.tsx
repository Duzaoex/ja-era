    ...
    return (
        <div className={`${style.sidebar} ${className}`}>
            <div className={style.profile}>
                <img src="src/util/images/1683649778499.png" alt="Eduardo Carneiro" className={style.profilePic} />
            ...
            <nav className={style.nav}>
                ...
                <a href="https://wa.me/seunumerodetelefone" className={`${style.navItem} ${style.whatsappButton}`}>Contato por WhatsApp</a>
            </nav>
        </div>
    );
}
